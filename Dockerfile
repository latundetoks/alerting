...
LABEL maintainer="Olatunde Tokun, https://github.com/latundetoks"
...
ENV LOG_DIR /etc/logs
# Elastalert home directory full path.
ENV ELASTALERT_HOME /etc/elastalert
...
RUN yum update && \
    yum upgrade && \
    yum add ca-certificates openssl-dev openssl libffi-dev python2 python2-dev py2-pip py2-yaml gcc musl-dev tzdata openntpd wget && \
